...
C_DEPS += \
./user_code/HAL/hal_sys/hal_sys.d 

OBJS += \
./user_code/HAL/hal_sys/hal_sys.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/HAL/hal_sys/%.o: ../user_code/HAL/hal_sys/%.c user_code/HAL/hal_sys/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-HAL-2f-hal_sys

clean-user_code-2f-HAL-2f-hal_sys:
	-$(RM) ./user_code/HAL/hal_sys/hal_sys.d ./user_code/HAL/hal_sys/hal_sys.o

.PHONY: clean-user_code-2f-HAL-2f-hal_sys
