...
user_code/HAL/hal_cd4052b/%.o: ../user_code/HAL/hal_cd4052b/%.c user_code/HAL/hal_cd4052b/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-HAL-2f-hal_cd4052b

clean-user_code-2f-HAL-2f-hal_cd4052b:
	-$(RM) ./user_code/HAL/hal_cd4052b/hal_cd4052b.d ./user_code/HAL/hal_cd4052b/hal_cd4052b.o

.PHONY: clean-user_code-2f-HAL-2f-hal_cd4052b
