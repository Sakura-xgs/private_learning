...
C_DEPS += \
./user_code/APP/client/tcp_client.d 

OBJS += \
./user_code/APP/client/tcp_client.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/APP/client/%.o: ../user_code/APP/client/%.c user_code/APP/client/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-APP-2f-client

clean-user_code-2f-APP-2f-client:
	-$(RM) ./user_code/APP/client/tcp_client.d ./user_code/APP/client/tcp_client.o

.PHONY: clean-user_code-2f-APP-2f-client
