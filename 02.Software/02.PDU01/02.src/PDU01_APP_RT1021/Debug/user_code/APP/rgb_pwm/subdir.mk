...
C_SRCS += \
../user_code/APP/rgb_pwm/rgb_pwm.c 

C_DEPS += \
./user_code/APP/rgb_pwm/rgb_pwm.d 

OBJS += \
./user_code/APP/rgb_pwm/rgb_pwm.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/APP/rgb_pwm/%.o: ../user_code/APP/rgb_pwm/%.c user_code/APP/rgb_pwm/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-APP-2f-rgb_pwm

clean-user_code-2f-APP-2f-rgb_pwm:
	-$(RM) ./user_code/APP/rgb_pwm/rgb_pwm.d ./user_code/APP/rgb_pwm/rgb_pwm.o

.PHONY: clean-user_code-2f-APP-2f-rgb_pwm
