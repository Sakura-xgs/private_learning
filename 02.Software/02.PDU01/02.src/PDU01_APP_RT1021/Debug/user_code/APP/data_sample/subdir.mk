...
user_code/APP/data_sample/%.o: ../user_code/APP/data_sample/%.c user_code/APP/data_sample/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-APP-2f-data_sample

clean-user_code-2f-APP-2f-data_sample:
	-$(RM) ./user_code/APP/data_sample/data_sample.d ./user_code/APP/data_sample/data_sample.o

.PHONY: clean-user_code-2f-APP-2f-data_sample
