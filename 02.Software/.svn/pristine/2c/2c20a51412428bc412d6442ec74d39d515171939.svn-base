...
C_DEPS += \
./user_code/APP/pdu_can/pdu_can.d 

OBJS += \
./user_code/APP/pdu_can/pdu_can.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/APP/pdu_can/%.o: ../user_code/APP/pdu_can/%.c user_code/APP/pdu_can/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-APP-2f-pdu_can

clean-user_code-2f-APP-2f-pdu_can:
	-$(RM) ./user_code/APP/pdu_can/pdu_can.d ./user_code/APP/pdu_can/pdu_can.o

.PHONY: clean-user_code-2f-APP-2f-pdu_can
