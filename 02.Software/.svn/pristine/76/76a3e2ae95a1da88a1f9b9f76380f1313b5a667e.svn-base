...
user_code/HAL/factory_test/%.o: ../user_code/HAL/factory_test/%.c user_code/HAL/factory_test/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-HAL-2f-factory_test

clean-user_code-2f-HAL-2f-factory_test:
	-$(RM) ./user_code/HAL/factory_test/factory_test.d ./user_code/HAL/factory_test/factory_test.o

.PHONY: clean-user_code-2f-HAL-2f-factory_test
