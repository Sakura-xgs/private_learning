...
user_code/HAL/flash_data/%.o: ../user_code/HAL/flash_data/%.c user_code/HAL/flash_data/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-HAL-2f-flash_data

clean-user_code-2f-HAL-2f-flash_data:
	-$(RM) ./user_code/HAL/flash_data/flash_data.d ./user_code/HAL/flash_data/flash_data.o

.PHONY: clean-user_code-2f-HAL-2f-flash_data
