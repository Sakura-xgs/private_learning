...
#define BMS_MSG_TEMP_OFFSET			50U//℃

#define DEFAULT_CC1_12V_MAX			1280//0.01V
#define DEFAULT_CC1_12V_MIN			1120//0.01V
#define DEFAULT_CC1_6V_MAX			680//0.01V
#define DEFAULT_CC1_6V_MIN			520//0.01V
#define DEFAULT_CC1_4V_MAX			480//0.01V
#define DEFAULT_CC1_4V_MIN			320//0.01V

#define	DEFAULT_LIGHT_ON_TIME		18U//h
#define	DEFAULT_LIGHT_OFF_TIME		6U//h

//东八区偏移
#define TIMESTAMP_OFFSET			(8*60*60U)
//枪温告警限制
#define WARNNING_TEMP       		70U
//枪温故障限制
#define FAULT_TEMP           		100U
//温差限制
#define TEMP_DIFF            		15U
...
#define C_LOGIN_IN_PILE_RESERVE_LEN    			20U
...
//报文未响应上限次数
#define LOGIN_UNANS_CNT_LIMIT           10U
