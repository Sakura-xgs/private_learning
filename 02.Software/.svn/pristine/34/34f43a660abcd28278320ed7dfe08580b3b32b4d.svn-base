...
C_DEPS += \
./user_code/APP/uart_comm/uart_comm.d 

OBJS += \
./user_code/APP/uart_comm/uart_comm.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/APP/uart_comm/%.o: ../user_code/APP/uart_comm/%.c user_code/APP/uart_comm/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-APP-2f-uart_comm

clean-user_code-2f-APP-2f-uart_comm:
	-$(RM) ./user_code/APP/uart_comm/uart_comm.d ./user_code/APP/uart_comm/uart_comm.o

.PHONY: clean-user_code-2f-APP-2f-uart_comm
