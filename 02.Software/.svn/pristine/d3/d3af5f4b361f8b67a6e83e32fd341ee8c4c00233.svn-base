...
user_code/APP/datasample/%.o: ../user_code/APP/datasample/%.c user_code/APP/datasample/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-APP-2f-datasample

clean-user_code-2f-APP-2f-datasample:
	-$(RM) ./user_code/APP/datasample/datasample.d ./user_code/APP/datasample/datasample.o

.PHONY: clean-user_code-2f-APP-2f-datasample
