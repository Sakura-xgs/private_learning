...
user_code/APP/relay_ctrl/%.o: ../user_code/APP/relay_ctrl/%.c user_code/APP/relay_ctrl/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-APP-2f-relay_ctrl

clean-user_code-2f-APP-2f-relay_ctrl:
	-$(RM) ./user_code/APP/relay_ctrl/relay_ctrl.d ./user_code/APP/relay_ctrl/relay_ctrl.o

.PHONY: clean-user_code-2f-APP-2f-relay_ctrl
