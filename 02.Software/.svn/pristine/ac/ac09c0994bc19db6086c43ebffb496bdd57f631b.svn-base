...
C_DEPS += \
./user_code/HAL/hal_eth/hal_eth.d 

OBJS += \
./user_code/HAL/hal_eth/hal_eth.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/HAL/hal_eth/%.o: ../user_code/HAL/hal_eth/%.c user_code/HAL/hal_eth/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-HAL-2f-hal_eth

clean-user_code-2f-HAL-2f-hal_eth:
	-$(RM) ./user_code/HAL/hal_eth/hal_eth.d ./user_code/HAL/hal_eth/hal_eth.o

.PHONY: clean-user_code-2f-HAL-2f-hal_eth
