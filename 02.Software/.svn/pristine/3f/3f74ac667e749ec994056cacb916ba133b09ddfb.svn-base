...
#define GY_STATUS_IMD_MODE_BIT        (2U)    // 状态字节第2位：IMD工作模式（0=固定，1=自动）
#define GY_STATUS_IMD_DATA_VALID_BIT  (1U)    // 状态字节第1位：IMD数据有效性
#define GY_STATUS_IMD_ENABLE_BIT      (2U)    // 状态字节第2位：IMD使能状态
#define GY_STATUS_IMD_SELFCHECK_BIT   (4U)    // 状态字节第4位：IMD自检状态
#define GY_STATUS_IMD_BUS_BIT		  (7U)	  // 状态字节第7位：IMD母线状态
