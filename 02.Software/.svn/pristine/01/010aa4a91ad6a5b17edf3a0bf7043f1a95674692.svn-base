...
C_SRCS += \
../user_code/Signal/Signal.c 

C_DEPS += \
./user_code/Signal/Signal.d 

OBJS += \
./user_code/Signal/Signal.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/Signal/%.o: ../user_code/Signal/%.c user_code/Signal/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-Signal

clean-user_code-2f-Signal:
	-$(RM) ./user_code/Signal/Signal.d ./user_code/Signal/Signal.o

.PHONY: clean-user_code-2f-Signal
