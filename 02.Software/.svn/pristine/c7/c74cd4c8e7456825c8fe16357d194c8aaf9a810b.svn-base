...
C_SRCS += \
../user_code/HAL/hal_adc/hal_adc.c 

C_DEPS += \
./user_code/HAL/hal_adc/hal_adc.d 

OBJS += \
./user_code/HAL/hal_adc/hal_adc.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/HAL/hal_adc/%.o: ../user_code/HAL/hal_adc/%.c user_code/HAL/hal_adc/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-HAL-2f-hal_adc

clean-user_code-2f-HAL-2f-hal_adc:
	-$(RM) ./user_code/HAL/hal_adc/hal_adc.d ./user_code/HAL/hal_adc/hal_adc.o

.PHONY: clean-user_code-2f-HAL-2f-hal_adc
