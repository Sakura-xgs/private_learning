...
C_SRCS += \
../user_code/APP/eth/eth.c 

C_DEPS += \
./user_code/APP/eth/eth.d 

OBJS += \
./user_code/APP/eth/eth.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/APP/eth/%.o: ../user_code/APP/eth/%.c user_code/APP/eth/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-APP-2f-eth

clean-user_code-2f-APP-2f-eth:
	-$(RM) ./user_code/APP/eth/eth.d ./user_code/APP/eth/eth.o

.PHONY: clean-user_code-2f-APP-2f-eth
