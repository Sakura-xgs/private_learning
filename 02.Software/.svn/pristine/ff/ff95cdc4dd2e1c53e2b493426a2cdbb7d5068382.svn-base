...
#ifndef USER_IPADDR1
#define USER_IPADDR1   172
#endif
#ifndef USER_IPADDR2
#define USER_IPADDR2   30
#endif
#ifndef USER_IPADDR3
#define USER_IPADDR3   1
#endif
#ifndef USER_IPADDR4
#define USER_IPADDR4   10
#endif
...
static void LWIP_IP_Reinit(void)
{
	...
	(void)GetSigVal(CCU_SET_SIG_ID_GUN_NUM, &uiTmp_flag);

	//有效编号
    if ((PILE_NUM_MIN <= uiTmp_flag) && (uiTmp_flag <= PILE_NUM_MAX))
    {
		IP4_ADDR(&lwIP_netif0_ipaddr, USER_IPADDR1, USER_IPADDR2, USER_IPADDR3, uiTmp_flag*10);
    }
    else
    {
		//设置为默认值1
		(void)SetSigVal(CCU_SET_SIG_ID_GUN_NUM, 1);
		IP4_ADDR(&lwIP_netif0_ipaddr, USER_IPADDR1, USER_IPADDR2, USER_IPADDR3, USER_IPADDR4);
    }
}
