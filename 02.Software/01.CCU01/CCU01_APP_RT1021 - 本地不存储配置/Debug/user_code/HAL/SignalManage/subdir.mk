...
user_code/HAL/SignalManage/%.o: ../user_code/HAL/SignalManage/%.c user_code/HAL/SignalManage/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-HAL-2f-SignalManage

clean-user_code-2f-HAL-2f-SignalManage:
	-$(RM) ./user_code/HAL/SignalManage/SignalManage.d ./user_code/HAL/SignalManage/SignalManage.o

.PHONY: clean-user_code-2f-HAL-2f-SignalManage
