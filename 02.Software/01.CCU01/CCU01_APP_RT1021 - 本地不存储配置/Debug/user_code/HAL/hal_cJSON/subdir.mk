...
C_SRCS += \
../user_code/HAL/hal_cJSON/cJSON.c 

C_DEPS += \
./user_code/HAL/hal_cJSON/cJSON.d 

OBJS += \
./user_code/HAL/hal_cJSON/cJSON.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/HAL/hal_cJSON/%.o: ../user_code/HAL/hal_cJSON/%.c user_code/HAL/hal_cJSON/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-HAL-2f-hal_cJSON

clean-user_code-2f-HAL-2f-hal_cJSON:
	-$(RM) ./user_code/HAL/hal_cJSON/cJSON.d ./user_code/HAL/hal_cJSON/cJSON.o

.PHONY: clean-user_code-2f-HAL-2f-hal_cJSON
