...
../user_code/HAL/boot/boot.c \
../user_code/HAL/boot/uart_boot.c 

C_DEPS += \
./user_code/HAL/boot/TcpBoot.d \
./user_code/HAL/boot/boot.d \
./user_code/HAL/boot/uart_boot.d 

OBJS += \
./user_code/HAL/boot/TcpBoot.o \
./user_code/HAL/boot/boot.o \
./user_code/HAL/boot/uart_boot.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/HAL/boot/%.o: ../user_code/HAL/boot/%.c user_code/HAL/boot/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-HAL-2f-boot

clean-user_code-2f-HAL-2f-boot:
	-$(RM) ./user_code/HAL/boot/TcpBoot.d ./user_code/HAL/boot/TcpBoot.o ./user_code/HAL/boot/boot.d ./user_code/HAL/boot/boot.o ./user_code/HAL/boot/uart_boot.d ./user_code/HAL/boot/uart_boot.o

.PHONY: clean-user_code-2f-HAL-2f-boot
