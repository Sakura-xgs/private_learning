...
C_DEPS += \
./user_code/APP/led/led.d 

OBJS += \
./user_code/APP/led/led.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/APP/led/%.o: ../user_code/APP/led/%.c user_code/APP/led/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-APP-2f-led

clean-user_code-2f-APP-2f-led:
	-$(RM) ./user_code/APP/led/led.d ./user_code/APP/led/led.o

.PHONY: clean-user_code-2f-APP-2f-led
