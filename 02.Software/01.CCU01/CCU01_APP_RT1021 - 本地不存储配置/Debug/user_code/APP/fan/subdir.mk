...
C_SRCS += \
../user_code/APP/fan/fan_pwm.c 

C_DEPS += \
./user_code/APP/fan/fan_pwm.d 

OBJS += \
./user_code/APP/fan/fan_pwm.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/APP/fan/%.o: ../user_code/APP/fan/%.c user_code/APP/fan/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-APP-2f-fan

clean-user_code-2f-APP-2f-fan:
	-$(RM) ./user_code/APP/fan/fan_pwm.d ./user_code/APP/fan/fan_pwm.o

.PHONY: clean-user_code-2f-APP-2f-fan
