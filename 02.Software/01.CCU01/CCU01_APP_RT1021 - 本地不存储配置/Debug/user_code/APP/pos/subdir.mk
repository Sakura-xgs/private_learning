...
C_DEPS += \
./user_code/APP/pos/BF_pos.d \
./user_code/APP/pos/pos.d 

OBJS += \
./user_code/APP/pos/BF_pos.o \
./user_code/APP/pos/pos.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/APP/pos/%.o: ../user_code/APP/pos/%.c user_code/APP/pos/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-APP-2f-pos

clean-user_code-2f-APP-2f-pos:
	-$(RM) ./user_code/APP/pos/BF_pos.d ./user_code/APP/pos/BF_pos.o ./user_code/APP/pos/pos.d ./user_code/APP/pos/pos.o

.PHONY: clean-user_code-2f-APP-2f-pos
