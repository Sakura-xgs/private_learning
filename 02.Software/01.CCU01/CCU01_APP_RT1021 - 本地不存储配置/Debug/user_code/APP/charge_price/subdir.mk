...
user_code/APP/charge_price/%.o: ../user_code/APP/charge_price/%.c user_code/APP/charge_price/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-APP-2f-charge_price

clean-user_code-2f-APP-2f-charge_price:
	-$(RM) ./user_code/APP/charge_price/charge_price.d ./user_code/APP/charge_price/charge_price.o

.PHONY: clean-user_code-2f-APP-2f-charge_price
