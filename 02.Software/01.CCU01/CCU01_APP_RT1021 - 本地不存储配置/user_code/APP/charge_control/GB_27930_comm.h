...
typedef struct
{
    U16 unSingle_battery_max_allow_vol;	//0.01V 0~24
...
typedef struct
{
	...
	U16 unMax_single_vol_and_group;	//0.01V
	U8  ucCurrent_SOC;				//%1
...
typedef struct
{
    U8 ucMax_single_vol_num;
    U8 ucMax_battery_temp;	//1℃
    U8 ucMax_temp_num;
    U8 ucMin_battery_temp;	//1℃
    U8 ucMin_temp_num;
    U8 ucSingle_battery_vol_state:2;
...
{
    U8 ucStop_SOC;			//%1
	U16 unMin_single_vol;	//0.01V
	U16 unMax_single_vol;	//0.01V
	U8 ucMin_battery_temp;	//1℃
	U8 ucMax_battery_temp;	//1℃
}GB_BSD_Data_t;
...
void GB_BclMessageProcess(const GB_BCL_Data_t sBSL_data, const U8 ucGun_id);
