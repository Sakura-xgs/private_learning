...
//继电器控制 CLSOE:闭合  OPEN：断开
#define CLOSE_CONTROL   	 0x01U
#define OPEN_CONTROL    	 0x00U
//防雷
#define SPD_ENABLE           0x01
#define SPD_DISENABLE        0x00
//门禁
#define DOOR_ENABLE          0x01
#define DOOR_DISENABLE       0x00
//水浸
#define WATER_ENABLE         0x01
#define WATER_DISENABLE      0x00
//防撞击
#define HIT_ENABLE           0x01
#define HIT_DISENABLE        0x00
//断路器（塑壳）
#define MCB_ENABLE           0x01
#define MCB_DISENABLE        0x00
...
typedef union
{
    ...
    struct
    {
		...
		U32 unBms_single_vol_Abnormal:1;	//BMS单体电压异常异常
...
typedef union
{
    ...
    struct
    {
		...
		U32 start_vol_more_than_safe_vol:1;//启动时外侧有明显电压（>10V）
