...
SemaphoreHandle_t g_sStart_timing_sem[GUN_MAX_NUM] = {NULL};

static U32 g_uiFee_cnt[GUN_MAX_NUM] = {0};
static TimerHandle_t g_sTimer_occupation_fee[GUN_MAX_NUM] = {NULL};
// 24小时峰谷电价表（0.01元/度单位）
