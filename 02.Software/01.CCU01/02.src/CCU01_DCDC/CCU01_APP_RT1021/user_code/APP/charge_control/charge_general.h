...
//继电器控制间隔
#define RELAY_CONTROL_DELAY		50//ms
//兼容需求电压为0的SOC值为正常停充
#define SOC_0V_STOP_NORMAL_MIN  99
//充电无效剩余时间
#define INVALID_REMAIEND_TIME   0xFFFF
//CIG继电器控制等待周期
...
#define FAULT_OVER_VOL_TIMEOUT  1000U //ms
//普通过压故障时间
...
#define OVER_CUR_TIMEOUT        3000U //ms
#define FAULT_OVER_CUR_LIMIT    130	//1.3
#define FAULT_OVER_CUR_TIMEOUT  1500U //ms
...
#define WELD_DETECTION_TIMEOUT			(5000U)
