...
#define APP_TOTAL_SIZE		(0x80000U)	//APP total size is 512KB
#define APP_INTEG_FG_OFFSET	(0x100U)	//APP total size is 512KB
#define APP_INTEG_SIZE		(16U)		//APP integ_flag's length 16 byte
#define APP_FLASH_ADDR_START  			(0x60010000U)//APP begin address
