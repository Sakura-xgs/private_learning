...
C_DEPS += \
./user_code/HAL/hal_uart/hal_uart.d 

OBJS += \
./user_code/HAL/hal_uart/hal_uart.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/HAL/hal_uart/%.o: ../user_code/HAL/hal_uart/%.c user_code/HAL/hal_uart/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-HAL-2f-hal_uart

clean-user_code-2f-HAL-2f-hal_uart:
	-$(RM) ./user_code/HAL/hal_uart/hal_uart.d ./user_code/HAL/hal_uart/hal_uart.o

.PHONY: clean-user_code-2f-HAL-2f-hal_uart
