...
user_code/HAL/hal_eeprom/%.o: ../user_code/HAL/hal_eeprom/%.c user_code/HAL/hal_eeprom/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-HAL-2f-hal_eeprom

clean-user_code-2f-HAL-2f-hal_eeprom:
	-$(RM) ./user_code/HAL/hal_eeprom/hal_eeprom.d ./user_code/HAL/hal_eeprom/hal_eeprom.o

.PHONY: clean-user_code-2f-HAL-2f-hal_eeprom
