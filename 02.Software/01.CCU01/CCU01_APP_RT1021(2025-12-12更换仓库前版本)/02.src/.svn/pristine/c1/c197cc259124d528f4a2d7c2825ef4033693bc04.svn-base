...
user_code/HAL/calculate_crc/%.o: ../user_code/HAL/calculate_crc/%.c user_code/HAL/calculate_crc/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-HAL-2f-calculate_crc

clean-user_code-2f-HAL-2f-calculate_crc:
	-$(RM) ./user_code/HAL/calculate_crc/calculate_crc.d ./user_code/HAL/calculate_crc/calculate_crc.o

.PHONY: clean-user_code-2f-HAL-2f-calculate_crc
