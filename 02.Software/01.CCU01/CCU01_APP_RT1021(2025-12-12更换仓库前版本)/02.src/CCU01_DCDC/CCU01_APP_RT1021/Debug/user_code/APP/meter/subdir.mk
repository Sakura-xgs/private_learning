...
C_DEPS += \
./user_code/APP/meter/AKR_meter.d \
./user_code/APP/meter/DH_meter.d \
./user_code/APP/meter/meter.d 

OBJS += \
./user_code/APP/meter/AKR_meter.o \
./user_code/APP/meter/DH_meter.o \
./user_code/APP/meter/meter.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/APP/meter/%.o: ../user_code/APP/meter/%.c user_code/APP/meter/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-APP-2f-meter

clean-user_code-2f-APP-2f-meter:
	-$(RM) ./user_code/APP/meter/AKR_meter.d ./user_code/APP/meter/AKR_meter.o ./user_code/APP/meter/DH_meter.d ./user_code/APP/meter/DH_meter.o ./user_code/APP/meter/meter.d ./user_code/APP/meter/meter.o

.PHONY: clean-user_code-2f-APP-2f-meter
