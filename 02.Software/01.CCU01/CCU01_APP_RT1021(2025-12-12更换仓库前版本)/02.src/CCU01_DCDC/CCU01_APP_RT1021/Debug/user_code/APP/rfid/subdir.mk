...
C_DEPS += \
./user_code/APP/rfid/HW_rfid.d \
./user_code/APP/rfid/rfid.d 

OBJS += \
./user_code/APP/rfid/HW_rfid.o \
./user_code/APP/rfid/rfid.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/APP/rfid/%.o: ../user_code/APP/rfid/%.c user_code/APP/rfid/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-APP-2f-rfid

clean-user_code-2f-APP-2f-rfid:
	-$(RM) ./user_code/APP/rfid/HW_rfid.d ./user_code/APP/rfid/HW_rfid.o ./user_code/APP/rfid/rfid.d ./user_code/APP/rfid/rfid.o

.PHONY: clean-user_code-2f-APP-2f-rfid
