...
static void GYDataParse(const Gun_Id_e eGun_id)
{
	...
	//当前状态
	g_sGY_IMD.sPublic_data[eGun_id].bImd_data_valid = (BOOL)((g_sGY_receive_data.ucStatus[1] >> 1U) & 0x01U);
	g_sGY_IMD.sPublic_data[eGun_id].bImd_enable_status = (BOOL)((g_sGY_receive_data.ucStatus[1] >> 2U) & 0x01U);
	g_sGY_IMD.sPublic_data[eGun_id].bImd_checkself_status = (BOOL)((g_sGY_receive_data.ucStatus[1] >> 4U) & 0x01U);
