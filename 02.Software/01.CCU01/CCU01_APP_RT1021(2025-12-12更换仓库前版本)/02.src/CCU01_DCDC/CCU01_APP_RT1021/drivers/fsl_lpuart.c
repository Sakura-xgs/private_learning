...
void LPUART1_DriverIRQHandler(void)
{
	uint32_t irq_flag = LPUART_GetStatusFlags(LPUART1);
	if(irq_flag & kLPUART_IdleLineFlag)
	{
		/* 清除空闲中断标志位 */
		LPUART_ClearStatusFlags(LPUART1, kLPUART_IdleLineFlag);
		LPUART_IRQ_User_handle(e_UART_1);
	}
	else if(irq_flag & kLPUART_TransmissionCompleteFlag)
	{
	    s_lpuartIsr[1](LPUART1, s_lpuartHandle[1]);
	    SDK_ISR_EXIT_BARRIER;
	}
...
void LPUART2_DriverIRQHandler(void)
{
	uint32_t irq_flag = LPUART_GetStatusFlags(LPUART2);
	if(irq_flag & kLPUART_IdleLineFlag)
	{
		/* 清除空闲中断标志位 */
		LPUART_ClearStatusFlags(LPUART2, kLPUART_IdleLineFlag);
		LPUART_IRQ_User_handle(e_UART_2);
	}
	else if(irq_flag & kLPUART_TransmissionCompleteFlag)
	{
	    s_lpuartIsr[2](LPUART2, s_lpuartHandle[2]);
...
void LPUART3_DriverIRQHandler(void)
{
	uint32_t irq_flag = LPUART_GetStatusFlags(LPUART3);
	if(irq_flag & kLPUART_IdleLineFlag)
	{
		/* 清除空闲中断标志位 */
		LPUART_ClearStatusFlags(LPUART3, kLPUART_IdleLineFlag);
		LPUART_IRQ_User_handle(e_UART_3);
	}
	else if(irq_flag & kLPUART_TransmissionCompleteFlag)
	{
	    s_lpuartIsr[3](LPUART3, s_lpuartHandle[3]);
...
void LPUART4_DriverIRQHandler(void)
{
	uint32_t irq_flag = LPUART_GetStatusFlags(LPUART4);
	if(irq_flag & kLPUART_IdleLineFlag)
	{
		/* 清除空闲中断标志位 */
		LPUART_ClearStatusFlags(LPUART4, kLPUART_IdleLineFlag);
		LPUART_IRQ_User_handle(e_UART_4);
	}
	else if(irq_flag & kLPUART_TransmissionCompleteFlag)
	{
	    s_lpuartIsr[4](LPUART4, s_lpuartHandle[4]);
...
void LPUART5_DriverIRQHandler(void)
{
	uint32_t irq_flag = LPUART_GetStatusFlags(LPUART5);
	if(irq_flag & kLPUART_IdleLineFlag)
	{
		/* 清除空闲中断标志位 */
		LPUART_ClearStatusFlags(LPUART5, kLPUART_IdleLineFlag);
		LPUART_IRQ_User_handle(e_UART_5);
	}
	else if(irq_flag & kLPUART_TransmissionCompleteFlag)
	{
	    s_lpuartIsr[5](LPUART5, s_lpuartHandle[5]);
...
void LPUART6_DriverIRQHandler(void)
{
	uint32_t irq_flag = LPUART_GetStatusFlags(LPUART6);
	if(irq_flag & kLPUART_IdleLineFlag)
	{
		/* 清除空闲中断标志位 */
		LPUART_ClearStatusFlags(LPUART6, kLPUART_IdleLineFlag);
		LPUART_IRQ_User_handle(e_UART_6);
	}
	else if(irq_flag & kLPUART_TransmissionCompleteFlag)
	{
	    s_lpuartIsr[6](LPUART6, s_lpuartHandle[6]);
...
void LPUART7_DriverIRQHandler(void)
{
	uint32_t irq_flag = LPUART_GetStatusFlags(LPUART7);
	if(irq_flag & kLPUART_IdleLineFlag)
	{
		/* 清除空闲中断标志位 */
		LPUART_ClearStatusFlags(LPUART7, kLPUART_IdleLineFlag);
		LPUART_IRQ_User_handle(e_UART_7);
	}
	else if(irq_flag & kLPUART_TransmissionCompleteFlag)
	{
	    s_lpuartIsr[7](LPUART7, s_lpuartHandle[7]);
...
void LPUART8_DriverIRQHandler(void)
{
	uint32_t irq_flag = LPUART_GetStatusFlags(LPUART8);
	if(irq_flag & kLPUART_IdleLineFlag)
	{
		/* 清除空闲中断标志位 */
		LPUART_ClearStatusFlags(LPUART8, kLPUART_IdleLineFlag);
		LPUART_IRQ_User_handle(e_UART_8);
	}
	else if(irq_flag & kLPUART_TransmissionCompleteFlag)
	{
	    s_lpuartIsr[8](LPUART8, s_lpuartHandle[8]);
