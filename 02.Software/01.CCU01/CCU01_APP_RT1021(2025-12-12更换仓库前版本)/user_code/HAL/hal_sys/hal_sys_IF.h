...
/***************Relay******************/
#define POSITIVE_RELAY_A_CLOSE()			GPIO_PortSet(BOARD_INITPINS_K1_GPIO, 1UL << BOARD_INITPINS_K1_GPIO_PIN)
#define POSITIVE_RELAY_A_OPEN()		GPIO_PortClear(BOARD_INITPINS_K1_GPIO, 1UL << BOARD_INITPINS_K1_GPIO_PIN)

#define NEGATIVE_RELAY_A_CLOSE()			GPIO_PortSet(BOARD_INITPINS_K2_GPIO, 1UL << BOARD_INITPINS_K2_GPIO_PIN)
#define NEGATIVE_RELAY_A_OPEN()		GPIO_PortClear(BOARD_INITPINS_K2_GPIO, 1UL << BOARD_INITPINS_K2_GPIO_PIN)

#define POSITIVE_RELAY_B_CLOSE()			GPIO_PortSet(BOARD_INITPINS_K3_GPIO, 1UL << BOARD_INITPINS_K3_GPIO_PIN)
#define POSITIVE_RELAY_B_OPEN()		GPIO_PortClear(BOARD_INITPINS_K3_GPIO, 1UL << BOARD_INITPINS_K3_GPIO_PIN)

#define NEGATIVE_RELAY_B_CLOSE()			GPIO_PortSet(BOARD_INITPINS_K4_GPIO, 1UL << BOARD_INITPINS_K4_GPIO_PIN)
#define NEGATIVE_RELAY_B_OPEN()		GPIO_PortClear(BOARD_INITPINS_K4_GPIO, 1UL << BOARD_INITPINS_K4_GPIO_PIN)

#define PRECHARGE_RELAY_A_CLOSE()			GPIO_PortSet(BOARD_INITPINS_K5_GPIO, 1UL << BOARD_INITPINS_K5_GPIO_PIN)
#define PRECHARGE_RELAY_A_OPEN()		GPIO_PortClear(BOARD_INITPINS_K5_GPIO, 1UL << BOARD_INITPINS_K5_GPIO_PIN)

#define PRECHARGE_RELAY_B_CLOSE()			GPIO_PortSet(BOARD_INITPINS_K6_GPIO, 1UL << BOARD_INITPINS_K6_GPIO_PIN)
#define PRECHARGE_RELAY_B_OPEN()		GPIO_PortClear(BOARD_INITPINS_K6_GPIO, 1UL << BOARD_INITPINS_K6_GPIO_PIN)
//硬件上做了电平反向，K7继电器更改电平方向，
#define K7_DISABLE()			GPIO_PortSet(BOARD_INITPINS_K7_GPIO, 1UL << BOARD_INITPINS_K7_GPIO_PIN)
#define K7_ENABLE()		GPIO_PortClear(BOARD_INITPINS_K7_GPIO, 1UL << BOARD_INITPINS_K7_GPIO_PIN)

#define K8_ENABLE()			GPIO_PortSet(BOARD_INITPINS_K8_GPIO, 1UL << BOARD_INITPINS_K8_GPIO_PIN)
#define K8_DISABLE()		GPIO_PortClear(BOARD_INITPINS_K8_GPIO, 1UL << BOARD_INITPINS_K8_GPIO_PIN)
