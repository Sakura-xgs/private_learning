...
user_code/APP/fault/%.o: ../user_code/APP/fault/%.c user_code/APP/fault/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-APP-2f-fault

clean-user_code-2f-APP-2f-fault:
	-$(RM) ./user_code/APP/fault/emergency_fault.d ./user_code/APP/fault/emergency_fault.o

.PHONY: clean-user_code-2f-APP-2f-fault
