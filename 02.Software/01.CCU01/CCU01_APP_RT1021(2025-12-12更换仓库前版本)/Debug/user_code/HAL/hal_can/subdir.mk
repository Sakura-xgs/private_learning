...
C_SRCS += \
../user_code/HAL/hal_can/can_fifo.c \
../user_code/HAL/hal_can/hal_can.c 

C_DEPS += \
./user_code/HAL/hal_can/can_fifo.d \
./user_code/HAL/hal_can/hal_can.d 

OBJS += \
./user_code/HAL/hal_can/can_fifo.o \
./user_code/HAL/hal_can/hal_can.o 


# Each subdirectory must supply rules for building sources it contributes
user_code/HAL/hal_can/%.o: ../user_code/HAL/hal_can/%.c user_code/HAL/hal_can/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-HAL-2f-hal_can

clean-user_code-2f-HAL-2f-hal_can:
	-$(RM) ./user_code/HAL/hal_can/can_fifo.d ./user_code/HAL/hal_can/can_fifo.o ./user_code/HAL/hal_can/hal_can.d ./user_code/HAL/hal_can/hal_can.o

.PHONY: clean-user_code-2f-HAL-2f-hal_can
