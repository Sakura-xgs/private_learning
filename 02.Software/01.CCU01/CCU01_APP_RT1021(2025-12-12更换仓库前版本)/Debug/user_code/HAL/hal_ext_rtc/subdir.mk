...
user_code/HAL/hal_ext_rtc/%.o: ../user_code/HAL/hal_ext_rtc/%.c user_code/HAL/hal_ext_rtc/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-user_code-2f-HAL-2f-hal_ext_rtc

clean-user_code-2f-HAL-2f-hal_ext_rtc:
	-$(RM) ./user_code/HAL/hal_ext_rtc/hal_ext_rtc.d ./user_code/HAL/hal_ext_rtc/hal_ext_rtc.o

.PHONY: clean-user_code-2f-HAL-2f-hal_ext_rtc
